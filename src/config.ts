...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable:true,
		src: "assets/images/122782209_p0_master1200.avif", // 相对于 /src 目录。如果以 '/' 开头则相对于 /public 目录
		
		position: "center", // 相当于 object-position，只支持 'top'、'center'、'bottom'。默认为 'center'
		credit: {
			enable: true, // 显示横幅图片的来源文字
			text: "Pixiv@chokei", // 要显示的来源文字
			url: "https://www.pixiv.net/artworks/122782209", // （可选）原作品或艺术家页面的 URL 链接
		},
	},
	toc: {
